...
def image_dataframe(image, input_cluster):
    ...
    data_dic = {'hex_code': hex_cols, 'rgb_code': ordered_colors, 'count': list(counts.values()),
                'proportion': count_props}
...
app.layout = html.Div([
    ...
    html.Div([
        ...
        html.Div([
            ...
            html.Div([
                html.Div(
                    children='The number of clusters determines the amount of colors in the breakdown. More clusters will give a more granular breakdown'
                    )],
